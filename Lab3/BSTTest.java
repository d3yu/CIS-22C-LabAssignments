...
public class BSTTest {
    public static void main(String[] args) {
        ...
        intBst.insert(17);
        intBst.insert(68);
        System.out.printf("InOrderPrint: Should print out 10 12 17 22 41 68: ");
        intBst.inOrderPrint();
        System.out.printf("\nPreOrderPrint: Should print out 10 22 12 17 41 68: ");
        intBst.preOrderPrint();
        System.out.printf("\nPostOrderPrint: Should print out 17 12 68 41 22 10: ");
        intBst.postOrderPrint();
       
        System.out.println("\nShould not be empty (false); " + intBst.isEmpty());
